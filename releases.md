...
- [461](https://github.com/SitecorePowerShell/Console/issues/461) `Receive-RemoteItem` replaces the `Receive-MediaItem` command for downloading files and media items.
...
- [447](https://github.com/SitecorePowerShell/Console/issues/447) `Lock-Item` now supports changing ownership with the *Force* switch to override the current owner when previously locked.
